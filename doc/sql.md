...
CREATE TABLE `client_test`.`coordinate_info` (
  ...
  `batch_id` varchar(128) NOT NULL DEFAULT '' COMMENT '批次id',
  `node_id` varchar(128) NOT NULL DEFAULT '' COMMENT '节点id',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='节点信息表';
```
...
CREATE TABLE `client_test`.`cmd_info` (
  ...
  `batch_id` varchar(128) NOT NULL DEFAULT '' COMMENT '批次id',
  `node_id` varchar(128) NOT NULL DEFAULT '' COMMENT '节点id',
  `sql` varchar(512) NOT NULL DEFAULT '' COMMENT 'sql语句',
  PRIMARY KEY (`id`),
  KEY `idx_batch_id_node_id` (`batch_id`,`node_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='任务信息表';
```
...
CREATE TABLE `client_test`.`cmd_order` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_batch_id_node_id` (`batch_id`,`node_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='任务顺序表';
```
